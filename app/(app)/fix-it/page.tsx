    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-black text-[#1D1D1F]">Fix-It Centre</h1>
            <p className="text-[#1D1D1F]/55 mt-0.5">Action plans for your low-scoring dimensions</p>
          </div>
        </div>

        {modules.length > 0 && (
          <div className="bg-[#F5F5F7] rounded-2xl border border-[#E8E8ED] p-4 flex items-center gap-6">
            <div className="text-center">
              <div className="text-2xl font-black text-[#1D1D1F]">{completedTasks}</div>
              <div className="text-xs text-[#1D1D1F]/55">tasks done</div>
            </div>
            <div className="h-8 w-px bg-[#E8E8ED]" />
            <div className="text-center">
              <div className="text-2xl font-black text-[#1D1D1F]">{totalTasks - completedTasks}</div>
              <div className="text-xs text-[#1D1D1F]/55">remaining</div>
            </div>
            <div className="h-8 w-px bg-[#E8E8ED]" />
            <div className="text-center">
              <div className="text-2xl font-black text-[#1D1D1F]">{modules.length}</div>
              <div className="text-xs text-[#1D1D1F]/55">active modules</div>
            </div>
          </div>
        )}
      </div>
      ...
      {modules.length === 0 ? (
        <Card>
          <CardContent className="py-16 text-center">
            ...
            <h3 className="text-xl font-bold text-[#1D1D1F] mb-2">No active Fix-It modules</h3>
            <p className="text-[#1D1D1F]/55 mb-6 max-w-sm mx-auto">
