      ...
      {ideas.length === 0 ? (
        <Card>
          <CardContent className="py-16 text-center">
            <Lightbulb className="h-12 w-12 text-[#6E6E73]/40 mx-auto mb-4" />
            <h3 className="text-xl font-bold text-[#1D1D1F] mb-2">No ideas yet</h3>
            <p className="text-[#1D1D1F]/55 mb-6">Start your first assessment to see your ideas here.</p>
            <Link href="/assessment/new">
              <Button>
                <Plus className="h-4 w-4" />
